import "./stayAtYourTop.css";

import Slider from "react-slick";
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
import { StayAtYourTopArray } from "../../Constant/constant";
import { useRef } from "react";
import { Link } from "react-router-dom";

function StayAtYourTop() {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
  ...
  return (
    <div className="stayAtYourTopContainer">
      <div className="stayAtYourTopBoldText">
        Stay at our top unique properties
      </div>
      <div className="stayAtYourTopLightText">
      ...
      <div className="propertySlider">
        ...
        <Slider {...settings} ref={sliderRef}>
          {StayAtYourTopArray.map((val, index) => {
            return (
