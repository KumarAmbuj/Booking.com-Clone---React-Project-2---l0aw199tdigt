...
import { TrendingCityArray } from "../../../Constant/constant";
...
function TrendingCities() {
  ...
  return (
    <div className="trendingCitiesContainer">
      <div className="propertySliderText">Trending cities</div>
      <div className="trendingCitiesLightText">
      ...
      <div className="propertySlider">
        ...
        <Slider {...settings} ref={sliderRef}>
          {TrendingCityArray.map((val, index) => {
            return (
              <Link
                ...
                key={index}
              >
                <div className="TrendingSliderCard">
                  <img src={val.image} alt="val.name" />
                  <div className="trendingCitiesImageText">{val.name}</div>
                  <div className="trendingCitiesImageLightText">{val.text}</div>
                </div>
              </Link>
            );
          })}
